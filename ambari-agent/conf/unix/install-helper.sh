...
OLD_COMMON_DIR="/usr/lib/python3.11/site-packages/ambari_commons"
OLD_RESOURCE_MANAGEMENT_DIR="/usr/lib/python3.11/site-packages/resource_management"
OLD_JINJA_DIR="/usr/lib/python3.11/site-packages/ambari_jinja2"
OLD_SIMPLEJSON_DIR="/usr/lib/python3.11/site-packages/ambari_simplejson"
OLD_AMBARI_AGENT_DIR="/usr/lib/python3.11/site-packages/ambari_agent"
...
locate_python(){
  local python_binaries="/usr/bin/python;/usr/bin/python3;/usr/bin/python3.11"
